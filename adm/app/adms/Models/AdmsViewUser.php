...
class AdmsViewUser
{
    ...
    public function viewUser(int $id, string $tipo): void
    {
        ...
        if ($tipo === 'aluno') {
            ...
            $viewUser->fullRead(
                "SELECT usr.id, usr.nome, usr.email, usr.imagem, NULL AS certificado_nut, 'aluno' AS tipo, usr.created, usr.modified, usr.fk_sits_usuario, sit.nome_sit AS nome_sit
                FROM alunos usr
            ...
            $viewUser->fullRead(
                "SELECT n.id, n.nome, n.email, n.certificado_nut, n.imagem, 'nutricionista' AS tipo, n.created, n.modified, n.fk_sits_usuario, sit.nome_sit AS nome_sit
            ...
            $viewUser->fullRead(
                "SELECT au.id, au.nome, au.email, NULL AS certificado_nut, au.imagem, 'administrador' AS tipo, au.created, au.modified, au.fk_sits_usuario, sit.nome_sit AS nome_sit
